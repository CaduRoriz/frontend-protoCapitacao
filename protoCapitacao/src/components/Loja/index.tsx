  ...
  return (
    <div id="modals" className={styles.lojaWrapper}>
      <button className={styles.lojaContainer} onClick={handleOpenModal}>
        <h3>
          {props.nome_fantasia ? props.nome_fantasia : props.razao_social}
        </h3>
      </button>
      ...
      <div className={styles.icons}>
        <button
          ...
          className={`${edit ? styles.editClicked : ""}`}
        >
        ...
        <button
          ...
          className={`${lixo ? styles.lixoClicked : ""}`}
        >
          <img className={styles.lixo} src="lixo.png" />
        </button>
      </div>
